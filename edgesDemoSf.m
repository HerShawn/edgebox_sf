...
do_dir='C:\Users\Administrator\Desktop\icdar数据集\';
dir_img = dir([do_dir 'Challenge2_Training_Task2_GT\*.bmp']);
num_img = length(dir_img);
for indexImg = 5:5
    img_value = dir_img(indexImg).name;
    img_value = img_value(1:end-4);
    img_name = [do_dir 'Challenge2_Training_Task2_GT\' img_value '.bmp'];
    g = imread(img_name);
