function model = n_edgesTrain( varargin )
...
forestDir = [opts.modelDir '/forest_posNeg/'];
...
treeFn = [opts.modelDir '/tree_posNeg/' opts.modelFnm '_tree'];
for i=1:nTrees
...
% finalize setup
treeDir = [opts.modelDir '/tree_posNeg/'];
