function [mserBBoxes,textBBoxes]=textInter_28(g,img_value,textBBoxes,mserBBoxes)
% [~,~,interBBoxesIdx]=selectStrongestBbox(textBBoxes(:,1:4),textBBoxes(:,5)+textBBoxes(:,6),'RatioType','Min','OverlapThreshold',0.9);
[~,~,interBBoxesIdx]=selectStrongestBbox(textBBoxes(:,1:4),textBBoxes(:,5),'RatioType','Min','OverlapThreshold',0.9);
